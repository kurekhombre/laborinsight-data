...
locals {
 ...
 # <------------------- właściwym podejściem w chmurach publicznych jest zakładanie dedykowanych kont serwisowych (SA) do usług. 
 # Tutaj widzę, że korzystasz z takiego głównego/projektowego. Dedykowanemu przypisujesz minimalne role jakich potrzebuje, aby usługa działała.
