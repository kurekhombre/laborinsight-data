...
# 3. Kolejna rzecz z dobrych praktyk to podawanie minimalnej wersji Terraforma do powołania środowiska (https://developer.hashicorp.com/terraform/language/block/terraform#required_version). Pozwala to uniknąć sytuacji takich, że kod korzysta z funkcji, których na przykład nie ma w wersji tf na której go odpalasz.
